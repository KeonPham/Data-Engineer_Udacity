Project: Data Warehouse on Redshift
...
create_table.py --- a python script to drop and create a new database sparkifydb and run this first then the etl.py
...
README.md ---- project information in details